...
<head>
    ...
    <title>Journal des Achats - Gestion Pharmacie</title>
...
<body class="bg-gray-100">
        ...
        <div class="container mx-auto px-4 py-4">
            <div class="flex flex-col md:flex-row md:justify-between md:items-center gap-4">
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        <h1 class="text-xl font-bold">Journal des Achats</h1>
                        <p class="text-sm text-red-100">Écritures comptables des achats</p>
                    </div>
                </div>
    ...
    <main class="container mx-auto px-4 py-6">
        ...
        <section class="bg-white rounded-lg shadow-md p-6 mb-6">
            <form method="GET" action="/comptabilite/journaux/achats" class="grid grid-cols-1 md:grid-cols-4 gap-4 items-end">
                <div>
        ...
        <section class="bg-white rounded-lg shadow-md p-6">
            <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-3 mb-4">
                <h2 class="text-lg font-semibold flex items-center">
                    ...
                    Écritures des achats
                </h2>
                <div class="space-x-2">
                    <a href="/comptabilite/exporter?type=journal&journal=AC&date_debut=<?= urlencode($dateDebut) ?>&date_fin=<?= urlencode($dateFin) ?>"
                ...
                <table class="w-full border-collapse">
                    ...
                    <tfoot>
                        <tr class="bg-gray-50 font-semibold">
                            <td colspan="7" class="border border-gray-300 px-4 py-2 text-right">Totaux</td>
